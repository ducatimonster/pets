...
class PetBreedsControllerTest < ActionController::TestCase
  ...
  test "should create pet_breed" do
    assert_difference('PetBreed.count') do
      post :create, pet_breed: { breed_id: @pet_breed.breed_id, notes: @pet_breed.notes, pet_id: @pet_breed.pet_id }
    end
  ...
  test "should update pet_breed" do
    patch :update, id: @pet_breed, pet_breed: { breed_id: @pet_breed.breed_id, notes: @pet_breed.notes, pet_id: @pet_breed.pet_id }
    assert_redirected_to pet_breed_path(assigns(:pet_breed))
  end
