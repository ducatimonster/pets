...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { incident_date: @incident.incident_date, incident_description: @incident.incident_description }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { incident_date: @incident.incident_date, incident_description: @incident.incident_description }
    assert_redirected_to incident_path(assigns(:incident))
  end
