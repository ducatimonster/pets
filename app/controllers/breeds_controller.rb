class BreedsController < ApplicationController
  ...
  # GET /breeds.json
  def index
    @breeds = Breed.all.order(breed: :asc).page(params[:page]).per_page(10)
  end

  def import
    Breed.import(params[:file])
    redirect_to breeds_url, notice: 'Breeds imported.'
  end
  ...
  def destroy
    @breed.destroy
    respond_to do |format|
      format.html { redirect_to breeds_url, notice: 'Breed was successfully deleted.' }
